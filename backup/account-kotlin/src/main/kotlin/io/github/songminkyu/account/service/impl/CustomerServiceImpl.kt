...
class CustomerServiceImpl(
    ...
    override fun fetchCustomerDetails(mobileNumber: String, correlationId: String): CustomerDetailsDTO {
        ...
        val account = accountRepository.findByCustomerId(customer.customerId!!).orElseThrow {
            EntityNotFoundException(Account::class.java, "customerId", customer.customerId.toString())
        }
