...
object SecurityUtils {
    ...
    fun isAuthenticated(): Boolean {
        ...
        return authentication != null &&
            getAuthorities(authentication).noneMatch { it == AuthoritiesConstants.ANONYMOUS }
    }
    ...
    private fun getAuthorities(authentication: Authentication): Stream<String> {
        ...
        return authorities.stream().map { it.authority }
    }
    ...
    private fun getRolesFromClaims(claims: Map<String, Any>): Collection<String> {
        return claims.getOrDefault("roles", emptyList<String>()) as Collection<String>
    }
