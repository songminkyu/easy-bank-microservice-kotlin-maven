package io.github.songminkyu.card.aspect
...
class LoggingAspect(private val env: Environment) {
    ...
    @Pointcut(
        ...
        " || within(@io.github.songminkyu.card.controller.GraphQLController *)"
    )
    ...
    @Pointcut(
        "within(io.github.songminkyu.card.repository..*)" +
        " || within(io.github.songminkyu.card.service..*)" +
        " || within(io.github.songminkyu.card.controller..*)"
    )
