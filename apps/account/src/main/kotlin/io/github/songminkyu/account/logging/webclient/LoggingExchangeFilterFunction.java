...
import static io.github.songminkyu.account.exception.fauxpas.FauxPas.throwingConsumer;
import static io.github.songminkyu.account.exception.fauxpas.FauxPas.throwingFunction;
                ...
                return Mono
                    ...
                    .flatMap(it -> {
                        ...
                        if (clientResponse.shouldBuffer() && (responseHeaders.getContentLength() > 0
                            || responseHeaders.containsHeader(TRANSFER_ENCODING))) {
                            return it
