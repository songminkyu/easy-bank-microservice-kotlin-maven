...
@Repository
interface AccountRepository : JpaRepository<Account?, Long?>, RevisionRepository<Account?, Long?, Int>,
    ...
    companion object {
        const val ACCOUNT_BY_CUSTOMER_ID_CACHE: String = "accountByCustomerId"
    }
}